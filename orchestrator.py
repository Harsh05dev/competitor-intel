...
def researcher_node(state: AgentState, agent: ResearcherAgent = None) -> dict:
    """
    Node 1 — Researcher
    ...
    researcher = agent or _get_agents()[0]
...
def categorizer_node(state: AgentState, agent: CategorizerAgent = None) -> dict:
    """
    Node 2 — Categorizer
    ...
    categorizer = agent or _get_agents()[1]
...
def analyst_node(state: AgentState, agent: AnalystAgent = None) -> dict:
    """
    Node 3 — Analyst
    ...
    analyst = agent or _get_agents()[2]
...
def evaluator_node(state: AgentState, agent: EvaluatorAgent = None) -> dict:
    """
    ...
    evaluator = agent or _get_agents()[3]
...
def build_graph(api_key: str = None):
    ...
    """
    if api_key:
        researcher, categorizer, analyst, evaluator = _new_agents(api_key)
    else:
        researcher, categorizer, analyst, evaluator = _get_agents()
...
def run_analysis(company: str, industry: str, api_key: str = None) -> AgentState:
    """
