...
def researcher_node(state: AgentState, researcher: ResearcherAgent) -> dict:
    """
    Node 1 — Researcher
...
def categorizer_node(state: AgentState, categorizer: CategorizerAgent) -> dict:
    """
    Node 2 — Categorizer
...
def analyst_node(state: AgentState, analyst: AnalystAgent) -> dict:
    """
    Node 3 — Analyst
...
def evaluator_node(state: AgentState, evaluator: EvaluatorAgent) -> dict:
    """
